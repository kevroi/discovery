...
python $me/discovery/experiments/FeatAct_minigrid/run_minigrid.py --env_name=$ENV_NAME --learner=$LEARNER --lr=$LR --run_num=$RUN --analyse_rep --use_wandb