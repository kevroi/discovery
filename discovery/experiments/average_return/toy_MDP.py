...
(graph_agent_0,) = plt.plot(
    x_legend, avg_ret[0], label="primitive actions", color="#E61C17"
)  # red
(graph_agent_2,) = plt.plot(
    x_legend, avg_ret[1], label="2 option", color="#26B812"
)  # green
plt.fill_between(
    x_legend,
    avg_ret[0] - std_err[0],
...
x_legend = range(num_episodes)
(graph_agent_0,) = plt.plot(
    x_legend, avg_steps[0], label="primitive actions", color="#E61C17"
)
