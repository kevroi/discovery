...
def plot_wandb_data(
    ...
    df = pd.read_csv(
        f"discovery/experiments/FeatAct_atari/wandb_export_data/{project_name}_{env_name[4:]}_{learner}_{activation}.csv"
    )
...
if __name__ == "__main__":
    ...
    # plt.show()
    plt.savefig("plots/learning_curves/seaquest_diff_acts.pdf")
