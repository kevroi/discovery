...
# save to csv
runs_df.to_csv(f"experiments/FeatAct_minigrid/wandb_export_data/{project}_{filter_dict['$and'][0]['config.env_name']}_{filter_dict['$and'][1]['config.learner']}_{filter_dict['$and'][2]['config.activation']}_{filter_dict['$and'][3]['config.feat_dim']}_data.csv")
